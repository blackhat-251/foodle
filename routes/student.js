...
router.get("/view_submission",async (req, res) => {
    ...
    res.render("student/view_submission",{files: f, user: req.user,assignments: filtered_ass })
})
...
router.get("/assignments", async (req, res) => {
    ...
    const f = await FileData.find({username: req.user.username})
    res.render("student/assignment", {user: req.user, assignments: filtered_ass, files: f})
})

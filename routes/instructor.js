...
router.get("/assignment", async (req, res) => {
    if (req.user.role == "instructor") {
        ...
        return res.render("instructor/assignment", { a: assignments, user: req.user });
    }
    else {
        return res.send("Unauthorized access")
    }
...
router.get("/view_submission/:code", async (req, res) => {
    ...
    return res.render("instructor/view_submission", {user: req.user, files: f, assignment: assignment })
})
